 ...
 * Pitch Algorithms
 *
 * Centralized signal processing logic for domain and infrastructure.
 */
 ...
 * @param rms - The RMS value of the buffer (pre-calculated).
 * @param diffsBuffer - A pre-allocated buffer for internal calculations (Zero-Allocation).
 */
